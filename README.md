...
Create an infinite Plex or Emby media cloud server with cloud storage on a VPS. It has full docker integration for all apps, NginX with reverse proxy and Letsencrypt, one step (automatic) backup and restore, several additional apps.
